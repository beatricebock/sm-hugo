...
+++
<div class="message success" data-component="message"> We are having a workshop on the 4th of May, come join us! <span class="close small"></span></div>
<h5>Join our <span class="highlight">FREE</span> forum to learn how to bring the best out of your company.</h5>
<br/>
<p>Enter your e-mail below and we'll contact you with more details.</p>
...
<form action="" data-component="validate" method="post" class="form form-centered"><input type="hidden" name="authorize-token" value="">
  ...
  <p><button class="button primary width-100">Contact Us</button></p>
